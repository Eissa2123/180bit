	...
	<div id="content">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                <a href="<?= WLink('purchasepayment/display/'.V($Cells, 'ID')) ?>" class="btn btn-default btn-block btn-control" role="button">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= WLink('purchasepayment/edit/'.V($Cells, 'ID')) ?>" method="post">       
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="provider" required="required">
                                    ...
                                    <?php if (isset($LProviders)){  ?>
                                        ...
                                        <option value="<?= V($Provider,'ID') ?>" <?= (V($Cells,'Provider', 'ID') == V($Provider,'ID')) ? 'selected="selected"' : '' ?>><?= V($Provider,'Code') ?> - <?= V($Provider,'Companyname') ?> <?= V($Provider,'Name') ?> : <?= V($Provider,'Job') ?></option>
                                        <?php }  ?>
                                    <?php }  ?>
                                </select>
                            </div>
