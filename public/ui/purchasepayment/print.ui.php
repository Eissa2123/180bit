	 ...
	 <div class="page-body">
        ...
        <table style="border:none;min-height:300px;">
            <thead>
                ...
                <tr>
                    <th class="text-right" style="width:30%;border:none;">إسم المزود</th>
                    <th class="text-center" style="width:40%;border:none;"><?= V($Cells, 'Provider', 'Companyname') ?></th>
                    <th class="text-left" style="width:30%;border:none;">Provider Name</th>
                </tr>
                <tr>
