	...
	<div id="content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= WLink('salequotation/add') ?>" method="post">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control multiselect" id="multiselect-customers" name="customer" data-multiple-name="<?= V($LTranslates,'Customer') ?>" data-multiple-nselected="<?= V($LTranslates,'NSelectedText') ?>" data-multiple-allselected="<?= V($LTranslates,'AllSelectedText') ?>" data-multiple-selectall="<?= V($LTranslates,'SelectAll') ?>">
                                            <option value="">&nbsp;</option>
                                            <?php if (isset($LCustomers)){  ?>
                                                <?php foreach ($LCustomers as $Customer) { ?>
                                                <option value="<?= V($Customer,'ID') ?>" data-id="<?= V($Customer,'ID') ?>" <?= I($Customer, 'ID', $LPosts, 'Customer') ? 'selected="selected"' : '' ?>>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
                                    <div class="form-group">
                                        <label for="products"><?= V($LTranslates, 'Products') ?></label>
                            ...
                            <div class="row articals">
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <?php if (L($LPosts, 'Products') or L($Cells, 'Products')){  ?>
                                                <?php foreach (J($LPosts, $Cells, 'Products') as $KProduct => $VProduct) { ?>
                                                    <tr>
                                                        <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="gift" value="<?= V($LPosts, 'Gift') ? V($LPosts, 'Gift') : '0.00' ?>" min="0.00" step="0.01" aria-label="Amount (to the nearest dollar)" required="required" readonly="readonly">
                                            <span class="input-group-addon"><?= V($LTranslates, 'Currency') ?></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control multiselect" id="multiselect-terms" name="terms[]" multiple="multiple" data-multiple-name="<?= V($LTranslates,'Terms') ?>" data-multiple-nselected="<?= V($LTranslates,'NSelectedText') ?>" data-multiple-allselected="<?= V($LTranslates,'AllSelectedText') ?>" data-multiple-selectall="<?= V($LTranslates,'SelectAll') ?>">
                                    ...
                                    <?php if (isset($LTerms)){  ?>
                                        ...
                                        <option value="<?= V($Term,'ID') ?>" <?= K($Term, 'ID', $LPosts, $Cells, 'Terms') ? 'selected="selected"' : '' ?>>
                                            <?= V($Term,'Name') ?>
                                        </option>
                                        <?php }  ?>
                                    <?php }  ?>
                    ...
                    <?php if(isset($Cells['ID'])){ ?>
                        <div class="row">
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-sm-offset-4 col-md-offset-4 col-lg-offset-4">
                                <div class="form-group">
                                    <a role="button" class="btn btn-success btn-block" name="btn_display" href="<?= WLink('salequotation/display/'.V($Cells, 'ID')) ?>">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-sm-offset-4 col-md-offset-4 col-lg-offset-4">
                                <div class="form-group">
                                    <a role="button" class="btn btn-info btn-block" name="btn_print" href="<?= WLink('salequotation/print/'.V($Cells, 'ID')) ?>" target="_blank">
                                        <?= V($LTranslates,'Print') ?> 
