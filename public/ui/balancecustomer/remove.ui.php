            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-sm-offset-2 col-md-offset-3 col-lg-offset-4">
                        <div class="form-group">
                            <form action="<?= WLink('balancecustomer/remove/'.V($Cells,'ID')) ?>" method="post">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            <a href="<?= WLink('balancecustomer/display/'.V($Cells,'ID')) ?>" class="btn btn-warning btn-block" role="button">  
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-sm-offset-3 col-md-offset-4 col-lg-offset-4">
                        <a href="<?= WLink('balancecustomer') ?>" class="btn btn-primary btn-block" role="button"> 
