	...
	<div id="content">
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?= V($LTranslates, 'BalanceCustomers') ?></li>
                </ol>
            </div>
            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                <a href="<?= WLink('balancecustomer/add') ?>" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates, 'Add') ?>  
                    <i class="glyphicon glyphicon-plus"></i> 
                </a>
            </div>
            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                <form action="<?= WLink('balancecustomer/prints') ?>" method="post" target="_blank">
        ...
        <div class="panel panel-default">
            <div class="panel-header">
                <div class="row">
                    <form action="<?= WLink('balancecustomer') ?>" method="post">
			...
			<?php if (isset($LRevenues)){  ?>
                <table class="table table-bordered table-striped">
                    <thead>
                        ...
                        <th class="text-center"><?= V($LTranslates,'Customer') ?></th>
                    ...
                    <tbody>
                        ...
                        <tr class="<?= V($revenue,'State', 'Class') ?>">
                            ...
                            <td class="text-center"><?= V($revenue,'Customer', 'Companyname') ?></td> 
                            <td class="text-center"><?= V($revenue, 'AT') ?> </td>
                            <td class="text-left"><?= V($revenue, 'Amount') ?> </td>
                            <td class="text-center actions">
                                <a href="<?= WLink('balancecustomer/print/'.V($revenue,'ID')) ?>" title="<?= V($LTranslates,'Print') ?>" target="_blank"><span class="glyphicon glyphicon-print"></span></a>	
                                <a href="<?= WLink('balancecustomer/display/'.V($revenue,'ID')) ?>" title="<?= V($LTranslates,'Display') ?>"><span class="glyphicon glyphicon-eye-open"></span></a>	
                                <a href="<?= WLink('balancecustomer/edit/'.V($revenue,'ID')) ?>" title="<?= V($LTranslates,'Edit') ?>"><span class="glyphicon glyphicon-edit"></span></a>	
                                <a href="<?= WLink('balancecustomer/remove/'.V($revenue,'ID')) ?>" title="<?= V($LTranslates,'Remove') ?>"><span class="glyphicon glyphicon-trash"></span></a>	
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
