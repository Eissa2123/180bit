	...
	<div id="content">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                <a href="<?= WEB ?>balanceproduct/display/<?= V($Cells, 'ID') ?>" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates, 'Details') ?>  
                    <i class="glyphicon glyphicon-eye-open"></i> 
                </a>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                <a href="<?= WEB ?>balanceproduct" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates,'List') ?>  
					...
					<div class="row">
						<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-sm-offset-2 col-md-offset-3 col-lg-offset-4">
							<div class="form-group">
								<form action="<?= WLink('balanceproduct/remove/'.V($Cells,'ID')) ?>" method="post">
						...
						<div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
							<div class="form-group">
								<a href="<?= WLink('balanceproduct/display/'.V($Cells,'ID')) ?>" class="btn btn-warning btn-block" role="button">  
                ...
                <?php } else { ?>
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-sm-offset-3 col-md-offset-4 col-lg-offset-4">
                            <a href="<?= WEB ?>balanceproduct" class="btn btn-primary btn-block" role="button"> 
                                <i class="glyphicon glyphicon-home"></i>  
                                <?= V($LTranslates, 'BalanceProducts') ?> 
                                <i class="glyphicon glyphicon-home"></i>  
                            </a>
                        </div>
                    </div>
