	...
	<div id="content">
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?= V($LTranslates, 'Purchasequotations') ?></li>
                </ol>
            </div>
            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                <form action="<?= WLink('purchasequotation/prints') ?>" method="post" target="_blank">
                    ...
                    <button type="submit" class="btn btn-info btn-control btn-block" name="btn_print">
                        <?= V($LTranslates, 'Print') ?>   
            ...
            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                <a href="<?= WLink('purchasequotation/add') ?>" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates, 'Add') ?>   
        ...
        <div class="panel panel-default">
            <div class="panel-header">
                <div class="row">
                    <form action="<?= WLink('purchasequotation') ?>" method="post">
						...
						<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="row">
								...
								<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
									<a href="<?= WLink('purchasequotation') ?>" class="btn btn-danger btn-block btn-control" role="button"><?= V($LTranslates,'Clean') ?>  
            ...
            <div class="panel-body" id="repport">
                <?php if (isset($LPurchasequotations)){  ?>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php foreach ($LPurchasequotations as $Purchase) { ?>
                        <tr class="<?= V($Purchase,'State', 'Class') ?>">
                            ...
                            <td class="text-center actions">
                                <a href="<?= WLink('purchasequotation/print/'.V($Purchase,'ID')) ?>" title="<?= V($LTranslates,'Print') ?>" target="_blank"><span class="glyphicon glyphicon-print"></span></a>
                                <a href="<?= WLink('purchasequotation/display/'.V($Purchase,'ID')) ?>" title="<?= V($LTranslates,'Display') ?>"><span class="glyphicon glyphicon-eye-open"></span></a>
                                <?php //if(V($Purchase,'State', 'ID') == '2') { ?>
                                <a href="<?= WLink('purchase/add/'.V($Purchase,'ID')) ?>" title="<?= V($LTranslates,'Add') ?> <?= V($LTranslates,'Purchase') ?>"><span class="glyphicon glyphicon-share"></span></a>
                                <?php //} ?>
                                <?php /*
