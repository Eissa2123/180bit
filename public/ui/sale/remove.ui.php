	...
	<div id="content">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                <a href="<?= WEB ?>sale/display/<?= V($Cells, 'ID') ?>" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates, 'Details') ?>  
                    <i class="glyphicon glyphicon-eye-open"></i> 
                </a>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                <a href="<?= WEB ?>sale" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates,'List') ?>  
            ...
            <div class="panel-body">
							...
							<table class="table table-bordered table-">
								<thead>
									<tr class="gray">
										...
										<th class="text-center" style="width:40%"><?= V($LTranslates, 'Description') ?></th>
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 col-sm-offset-2 col-md-offset-3 col-lg-offset-4">
                        <div class="form-group">
                            <form action="<?= WEB ?>sale/remove/<?= V($Cells,'ID') ?>" method="post">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            <a href="<?= WEB ?>sale/display/<?= V($Cells,'ID') ?>" class="btn btn-warning btn-block" role="button">  
                ...
                <?php } else { ?>
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-sm-offset-3 col-md-offset-4 col-lg-offset-4">
                            <a href="<?= WEB ?>sale" class="btn btn-primary btn-block" role="button"> 
