	...
	<div id="content">
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-8 col-lg-8">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><?= V($LTranslates, 'Products') ?></li>
                </ol>
            </div>
            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                <a href="<?= WLink('product/add') ?>" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates, 'Add') ?>  
                    <i class="glyphicon glyphicon-plus"></i> 
                </a>
            </div>
            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                <form action="<?= WLink('product/prints') ?>" method="post" target="_blank">
        ...
        <div class="panel panel-default">
            <div class="panel-header">
                <div class="row">
                    <form action="<?= WLink('product') ?>" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <a href="<?= WLink('product') ?>" class="btn btn-danger btn-block btn-control" role="button">
                                <?= V($LTranslates,'Clean') ?>  
			...
			<?php if (isset($LProducts)){  ?>
                <table class="table table-bordered">
                    <thead>
                        ...
                        <th class="text-center"><?= V($LTranslates,'Cost') ?></th>
                        <th class="text-center"><?= V($LTranslates,'Price') ?></th>
                        <th class="text-center"><?= V($LTranslates,'Unite') ?></th>
                        <th class="text-center"><?= V($LTranslates,'Nature') ?></th>
                    ...
                    <tbody>
                        ...
                        <tr class="<?= V($product,'State', 'Class') ?>">
                            <td class="text-center"><?= V($product,'ID') ?></td> 
                            <td class="text-center hidden-xs"><?= V($product,'Code') ?></td> 
                            <td class="text-center"><?= V($product, 'Name') ?></td>
                            <td class="text-center"><?= V($product, 'Category', 'Name') ?></td>
                            <td class="text-center"><?= V($product, 'Cost') ?></td>
                            <td class="text-center"><?= V($product, 'Price') ?></td>
                            <td class="text-center"><?= V($product, 'Unite', 'Name') ?></td>
                            <td class="text-center"><?= V($product, 'Nature', 'Name'.LNG) ?></td>
                            <td class="text-center hidden-xs"><span class="label label-<?= V($product,'State', 'Class') ?>"><?= V($product,'State','Name'.LNG) ?></span></td> 
                            <td class="text-center actions">
                                <a href="<?= WLink('product/print/'.V($product,'ID')) ?>" title="<?= V($LTranslates,'Print') ?>" target="_blank"><span class="glyphicon glyphicon-print"></span></a>	
                                <a href="<?= WLink('product/display/'.V($product,'ID')) ?>" title="<?= V($LTranslates,'Display') ?>"><span class="glyphicon glyphicon-eye-open"></span></a>	
                                <a href="<?= WLink('product/edit/'.V($product,'ID')) ?>" title="<?= V($LTranslates,'Edit') ?>"><span class="glyphicon glyphicon-edit"></span></a>	
                                <a href="<?= WLink('product/remove/'.V($product,'ID')) ?>" title="<?= V($LTranslates,'Remove') ?>"><span class="glyphicon glyphicon-trash"></span></a>	
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
