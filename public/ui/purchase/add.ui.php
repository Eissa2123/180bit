	...
	<div id="content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= WLink('purchase/add') ?>" method="post">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
								        ...
								        <?php /*<span style="float:left;">
                                            <span>
                                                <input type="checkbox" class="tva-option" value="10" data-tva="10" <?= (V($LPosts, 'TVA') == '10') ? 'checked="checked"' : '' ?> /> 10%
                                            </span>
                                            <span>
                                                <input type="checkbox" class="tva-option" value="15" data-tva="15" <?= (V($LPosts, 'TVA') == '15') ? 'checked="checked"' : '' ?> /> 15%
                                            </span>
                                            <span>
                                                <input 
                                                    type="checkbox" 
                                                    ...
                                                    value="20" 
                                                    data-tva="20" 
                                                    <?= (V($LPosts, 'TVA') != '10' && V($LPosts, 'TVA') != '15') ? 'checked="checked"' : '' ?>
                                                /> 20%
                                            </span>
                                        </span>*/?>
                                        <div class="input-group">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="row">
                                ...
                                <?php /*<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select class="form-control" name="method" required="required">
                                                ...
                                                <?php if (isset($LMethods)){ ?>
                                                    ...
                                                    <option value="<?= V($Method,'ID') ?>" <?= (J($LPosts, $Cells, 'Method') == V($Method,'ID')) ? 'selected="selected"' : '' ?>><?= V($Method, 'Name'.LNG) ?></option>
                                                    <?php }  ?>
                                                <?php }  ?>
                                            </select>
                                            <span class="input-group-addon">%</span>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="paid" value="<?= V($LPosts, 'Paid') ? J($LPosts, 'Paid') : '0.00' ?>" min="0.00" step="0.01" aria-label="Amount (to the nearest dollar)" required="required">
                                            <span class="input-group-addon"><?= V($LTranslates, 'Currency') ?></span>
                                        </div>
                                    </div>
                                </div>*/ ?>
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 clear">
                                    <div class="form-group">
                                        <label for="paidmonetary"><?= V($LTranslates, 'Paid') ?> (<?= V($LTranslates, 'Monetary') ?>)</label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="paidmonetary" value="<?= V($LPosts, 'PaidMonetary') != '' ? V($LPosts, 'PaidMonetary') : '0.00' ?>" min="0.00" step="0.01" aria-label="Amount (to the nearest dollar)" required="required">
                                            <span class="input-group-addon"><?= V($LTranslates, 'Currency') ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="paidonline"><?= V($LTranslates, 'Paid') ?> (<?= V($LTranslates, 'Online') ?>)</label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="paidonline" value="<?= V($LPosts, 'PaidOnline') != '' ? V($LPosts, 'PaidOnline') : '0.00' ?>" min="0.00" step="0.01" aria-label="Amount (to the nearest dollar)" required="required">
                                            <span class="input-group-addon"><?= V($LTranslates, 'Currency') ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        <label for="paid"><?= V($LTranslates, 'Paid') ?></label>
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="paid" value="<?= V($LPosts, 'Paid') != '' ? V($LPosts, 'Paid') : '0.00' ?>" min="0.00" step="0.01" aria-label="Amount (to the nearest dollar)" readonly="readonly">
                                            <span class="input-group-addon"><?= V($LTranslates, 'Currency') ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="rest" value="<?= V($LPosts, 'Rest') ? V($LPosts, 'Rest') : '0.00' ?>" min="0.00" step="0.01" aria-label="Amount (to the nearest dollar)" required="required" readonly="readonly">
                                            <span class="input-group-addon"><?= V($LTranslates, 'Currency') ?></span>
                                        </div>
                                    </div>
                                </div>
