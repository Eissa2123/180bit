	...
	<div id="content">
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                <a href="<?= WEB ?>purchase/display/<?= V($Cells, 'ID') ?>" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates, 'Details') ?>  
                    <i class="glyphicon glyphicon-eye-open"></i> 
                </a>
            </div>
            <div class="col-xs-6 col-sm-2 col-md-2 col-lg-2">
                <a href="<?= WEB ?>purchase" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates,'List') ?>  
            ...
            <div class="panel-body">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-9">
						...
						<label><?= V($Cells, 'Provider', 'Code') ?> - <?= V($Cells, 'Provider', 'Companyname') ?> | <?= V($Cells, 'Provider', 'Name') ?> : <?= V($Cells, 'Provider', 'Job') ?></label>
					</div>
				</div>
                ...
                <div class="row">
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2 col-sm-offset-2 col-md-offset-3 col-lg-offset-4">
                        <div class="form-group">
                            <form action="<?= WEB ?>purchase/remove/<?= V($Cells,'ID') ?>" method="post">
                    ...
                    <div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            <a href="<?= WEB ?>purchase/display/<?= V($Cells,'ID') ?>" class="btn btn-warning btn-block" role="button">  
                ...
                <?php } else { ?>
                    <div class="row">
                        <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 col-sm-offset-3 col-md-offset-4 col-lg-offset-4">
                            <a href="<?= WEB ?>purchase" class="btn btn-primary btn-block" role="button"> 
                                <i class="glyphicon glyphicon-home"></i>  
                                <?= V($LTranslates, 'Purchases') ?> 
                                <i class="glyphicon glyphicon-home"></i>  
                            </a>
                        </div>
                    </div>
