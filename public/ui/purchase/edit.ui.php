	...
	<div id="content">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                <a href="<?= WLink('purchase/display/'.V($Cells, 'ID')) ?>" class="btn btn-default btn-block btn-control" role="button">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= WLink('purchase/edit/'.V($Cells, 'ID')) ?>" method="post">  
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        <label for="customer"><?= V($LTranslates, 'Provider') ?></label>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" class="form-control" name="rest" value="<?= V($Cells, 'Rest') ? V($Cells,'Rest') : '0.00' ?>" min="0.00" step="0.01" aria-label="Amount (to the nearest dollar)" required="required" readonly="readonly">
                                            <span class="input-group-addon"><?= V($LTranslates, 'Currency') ?></span>
                                        </div>
                                    </div>
                                </div>
