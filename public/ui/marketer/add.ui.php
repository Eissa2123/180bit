	...
	<div id="content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= WLink('marketer/add') ?>" method="post" enctype="multipart/form-data">
                    <div class="row">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
								   <div class="form-group">
										...
										<input type="text" class="form-control" id="name" name="name" value="<?= V($LPosts, 'Name') ?>" placeholder="<?= V($LTranslates,'Name') ?>" Name="required" />
									</div>
								</div>
							</div>
							<div class="row">
