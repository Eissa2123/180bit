	...
	<div id="content">
        <div class="row">
            <div class="col-xs-12 col-sm-9 col-md-10 col-lg-10">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?= WLink('purchasereturn/'.V($LPosts, 'Facture')) ?>"><?= V($LPosts, 'Facture') ?></a></li>
                    <li><a href="<?= WLink('purchasereturn/'.V($LPosts, 'Facture')) ?>"><?= V($LTranslates, 'Returns') ?></a></li>
                    <li class="active"><?= V($LTranslates, 'Add') ?></li>
                </ol>
            </div>
            <div class="col-xs-12 col-sm-3 col-md-2 col-lg-2">
                <a href="<?= WLink('purchasereturn/'.V($LPosts, 'Facture')) ?>" class="btn btn-default btn-block btn-control" role="button">
                    <?= V($LTranslates, 'Back') ?> 
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= WLink('purchasereturn/add/'.V($LPosts, 'Facture')) ?>" method="post">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" name="ttc" value="<?= V($LPosts, 'TTC') ? V($LPosts,'TTC') : '0.000' ?>" min="0.00" step="0.01" aria-label="Amount (to the nearest dollar)" required="required" readonly="readonly">
                                    <span class="input-group-addon"><?= V($LTranslates, 'Currency') ?></span>
                                </div>
                            </div>
                        </div>
