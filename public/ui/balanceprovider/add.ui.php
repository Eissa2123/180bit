	...
	<div id="content">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <form action="<?= WLink('balanceprovider/add') ?>" method="post" enctype="multipart/form-data">
					<div class="row"> 
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="provider" required="required">
                                    ...
                                    <?php if (isset($LProviders)){  ?>
                                        ...
                                        <option value="<?= V($Provider,'ID') ?>" <?= (V($LPosts,'Provider') == V($Provider,'ID')) ? 'selected="selected"' : '' ?>><?= V($Provider,'Code') ?> - <?= V($Provider,'Companyname') ?> <?= V($Provider,'Name') ?> : <?= V($Provider,'Job') ?></option>
                                        <?php }  ?>
                                    <?php }  ?>
                                </select>
                            </div>
