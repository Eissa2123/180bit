            ...
            <div class="panel-body">
						...
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-group">
									...
									<label><?= V($Cells,'Provider', 'Companyname') ?></label>
								</div>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<div class="form-group">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2 col-sm-offset-2 col-md-offset-3 col-lg-offset-4">
                        <div class="form-group">
                            <form action="<?= WLink('balanceprovider/remove/'.V($Cells,'ID')) ?>" method="post">
                    ...
                    <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                        <div class="form-group">
                            <a href="<?= WLink('balanceprovider/display/'.V($Cells,'ID')) ?>" class="btn btn-warning btn-block" role="button">  
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-sm-offset-3 col-md-offset-4 col-lg-offset-4">
                        <a href="<?= WLink('balanceprovider') ?>" class="btn btn-primary btn-block" role="button"> 
